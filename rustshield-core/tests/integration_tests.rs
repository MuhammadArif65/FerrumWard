use rustshield_core::fingerprint::get_hardware_id;
use rustshield_core::license::{generate_keypair, sign_license, LicenseData};
use rustshield_core::protection::checkpoint::verify_checkpoint;
