...
Under the hood, `rustshield-core` uses the `litcrypt` procedural macros. 
...
In your game code, you can use the `lc!` macro exported by `litcrypt` (if you use it directly) or rely on RustShield's internal obfuscated strings.
